                ...
                <div>
                  ...
                  {stat.percentage && (
                    <p className={`text-sm font-medium mt-1 ${
                      ...
                      {stat.percentage >= 0 ? '+' : ''}{formatPercent(stat.percentage)}
                    </p>
                  )}
                </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center">
                      ...
                      <span className={`text-sm font-medium ${
                        investment.dayChangePercent >= 0 ? 'text-success-600' : 'text-error-600'
                      }`}>
                        {investment.dayChangePercent >= 0 ? '+' : ''}{formatPercent(investment.dayChangePercent)}
                      </span>
                    </div>
                  </div>
                </div>
