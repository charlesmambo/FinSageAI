...
import { Brain, Lightbulb, AlertTriangle, Rocket, ChevronRight } from 'lucide-react';
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-primary-100">
              Personalized insights and recommendations based on your financial behavior
            </p>
          </div>
        </div>
      </Card>
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between mb-2">
                  ...
                  <span className={`px-2 py-1 text-xs rounded-full ml-2 ${
                    insight.type === 'tip' ? 'bg-primary-100 text-primary-700' :
                    insight.type === 'warning' ? 'bg-warning-100 text-warning-700' :
